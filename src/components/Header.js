    ...
    <header id="header" className="header">
      ...
      <div className="menu-header">
        ...
        <div className="menu-añadir-link">
          ...
          {mostrarAddLink ? <div className="newlink-contain"> <NewLink addLink={addLink}  /></div> : <div className="newlink-contain"> <NewLink addLink={addLink} /></div>}
          </div>
          <button onClick={() => setMostrarAddLink(!mostrarAddLink)} className="link-header">
            {mostrarAddLink ? <img
              src={addNewLink}
              alt="logo Linkshare"
              className="icono-link-menu"
